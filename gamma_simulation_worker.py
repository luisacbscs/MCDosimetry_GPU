...
def run_gamma_simulation(id_):
    ...
    print("[Gamma]", tia_file, "x", ct_file, "-->", out_path)
    ...
    dosimetry.set_output_basename(os.path.join(out_path, "Gamma"))
    ...
    voxel_source.set_energy_peak(208.4, 'keV', 0.1041)
    voxel_source.set_energy_peak(112.9, 'keV', 0.0623)
...
if __name__ == "__main__":
    ...
    run_gamma_simulation(patient_id)
